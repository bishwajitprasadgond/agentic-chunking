# -*- coding: utf-8 -*-
"""
Created on Wed Sep 11 11:22:35 2024
...
# Initialize IBM Generative AI credentials and interface
credentials = Credentials(api_key=os.getenv("IBM_API_KEY"))
client = LangChainInterface(credentials=credentials)
...
# Function to create embeddings using IBM Generative AI API
def create_embeddings(text: str):
    try:
        params = GenerateParams(
            prompt=text,
            model="text-embedding-model"  # Specify the model name if required
        )
