# -*- coding: utf-8 -*-
"""
Created on Fri Sep 13 16:38:13 2024
            ...
            search_results = [
                {
                    ...
                    'propositions': match['propositions']
                }
...
def send_and_get_reply_groq(query:str, text_str:str):
    ...
    prompt1 = (
        f"Based on the following given test, answer the query concisely. If the answer is not present, "
